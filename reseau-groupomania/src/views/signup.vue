          ...
          <v-col>
            <v-row>
              <v-text-field
               v-model="pseudo"
               :rules="pseudoRules"
                  label="pseudo" class="ma-2" 
                  require></v-text-field>
            </v-row>
               <v-row>
              <v-text-field
              v-model="email" label="Adresse Email" class="ma-2"
               :rules="emailRules"
            ...
            <v-row>
              ...
              :rules="passwordRules"  type="password" ></v-text-field>
            </v-row>
            <v-row justify="center">
              <v-btn class="mt-4" outlined color="green"  @click="submit()">signup</v-btn>
            </v-row>
          </v-col>
        </v-container>
      </v-form>
